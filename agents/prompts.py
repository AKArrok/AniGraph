...
# 禁止使用的 AI 套话清单（所有面向用户输出的节点共用）
# 分类：
#   - 报告体套话：推荐理由 / 综合分析 / 综上所述 / 综上 / 值得注意的是 / 根据分析 / 笔者认为
#   - 起手/收尾套话：首先 / 其次 / 总的来说 / 希望对你有帮助 / 以上就是
BANNED_PHRASES = "、".join([
    "推荐理由", "综合分析", "综上所述", "综上", "值得注意的是", "根据分析", "笔者认为",
    "首先", "其次", "总的来说", "希望对你有帮助", "以上就是",
])
