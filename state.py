...
class DimensionDecision(BaseModel):
    """ACG 维度分类结果"""
    dimensions: list[str] = Field(description="问题涉及的维度列表，至少一个，取值: rating/genre/director/seiyuu/similar/general")
    primary:    str       = Field(description="优先处理的维度，必须是单个维度名: rating/genre/director/seiyuu/similar/general 之一")
